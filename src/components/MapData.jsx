const MapData = () => {
  ...
  <g className="borders" fill="none">
    ...
    ></path>
    <path className="al-ms" d="m 620.9,365.1 1.3,2 -1.3,67 4.4,33.2"></path>
    <path className="al-tn" d="m 620.9,365.1 45.7,-4"></path>
    <path className="ar-la" d="m 516.7,414.2 52.3,-1.3"></path>
    <path
      className="ar-mo"
    ...
    ></path>
    <path className="ar-ok" d="m 507.9,400.5 .7,-39 -4.1,-24.4"></path>
    <path
      className="ar-tn"
    ...
    ></path>
    <path className="az-nm" d="m 253.8,311 -17.4,124.1"></path>
    <path
      className="az-nv"
      d="m 167.6,296.8 -3.4,17.5 -2.4,2.9 h -2 l -1.2,-2.7 -3.7,-1.4 -3.5,.6 -1,13.6 .5,4.9 -.5,2.9 -1.4,3"
    ></path>
    <path className="az-ut" d="m 167.6,296.8 46.2,8.2 40,6"></path>
    <path className="ca-nv" d="m 93.9,166.5 -16.4,63.1 1.1,3.5 70.4,105"
    ></path>
    <path className="ca-or" d="m 27.8,147.9 66.1,18.6"></path>
    <path className="co-ks" d="m 379.4,256.3 -4.8,67"></path>
    <path className="co-ne" d="m 347.7,231.8 33.1,2.4 -1.4,22.1"></path>
    <path className="co-nm" d="m 253.8,311 52.6,6.5 51.7,4.8"></path>
    <path className="co-ok" d="m 358.1,322.3 16.5,1"></path>
    <path className="co-ut" d="m 265.3,222.7 -11.5,88.3"></path>
    <path className="co-wy" d="m 265.3,222.7 44.9,5.7 37.5,3.4"></path>
    <path
      className="ct-ma"
    ...
    <path
      className="ct-ny"
      d="m 846.6,194.7 -1.7,-2.2 3.5,-3.4 -1.8,-1.5 -2.8,-16.3"></path>
    <path className="ct-ri" d="m 870.7,165.5 3.2,12.3 -.4,1.1 .4,1.8"></path>
    <path className="dc-md" d="m 801.8,254.6 1.7,-2.6 -2.6,-1.8 -1,1.7"
    ></path>
    <path
      className="dc-va"
      d="m 799.9,251.9 .5,.4 .4,.1 .6,.5 .3,.7 -.1,.5 .2,.5"></path>
    <path className="de-md" d="m 817.9,230.1 7.6,27.1 10.9,-2.3"></path>
    <path className="de-nj" d="m 823.8,227.2 -1,2.2 -.3,2.1"></path>
    ...
    ></path>
    <path className="ga-nc" d="m 689.5,358.2 21.4,-3"></path>
    <path
      className="ga-sc"
    ...
    ></path>
    <path className="ga-tn" d="m 666.6,361.1 22.9,-2.9"></path>
    <path
      className="ia-il"
    ...
    ></path>
    <path className="ia-mn" d="m 473.6,182 28.2,0 36.3,-.9 18.6,-.7"></path>
    <path
      className="ia-mo"
    ...
    ></path>
    <path className="id-nv" d="m 140.9,177.7 24.4,5.4 23.3,4.7"></path>
    <path
      className="id-or"
    ...
    ></path>
    <path className="id-ut" d="m 236.5,196 -47.9,-8.2"></path>
    <path className="id-wa" d="m 174.6,27.5 -12.7,56.1 .7,4 -1.1,4.3"></path>
    <path className="id-wy" d="m 245,141.2 -8.5,54.8"></path>
    <path
      className="il-in"
    ...
    ></path>
    <path className="il-wi" d="m 567.2,202 45.9,-2.8"></path>
    <path
      className="in-ky"
    ...
    ></path>
    <path className="in-mi" d="m 630.9,213.2 32.4,-3.4 .1,1.4"></path>
    <path className="in-oh" d="m 670,268.4 -6.6,-57.2"></path>
    <path
      className="ks-mo"
      d="m 504.3,326.3 -.5,-48.1 -3.2,-.7 -2.6,-4.7 -2.5,-2.5 .5,-2.3 2.7,-2.6 .1,-1.2 -1.5,-2.1 -.9,1 -2,-.6 -2.9,-3"
    ></path>
    <path className="ks-ne" d="m 379.4,256.3 36,2 43.7,1.2 h 32.4"></path>
    <path className="ks-ok" d="m 374.6,323.3 67.7,2.9 62,.1"></path>
    <path
      className="ky-mo"
    ...
    ></path>
    <path className="ma-ny" d="m 843.8,171.3 -.7,-1 .5,-15"></path>
    <path
      className="ma-ri"
      d="m 870.7,165.5 6.5,-2 .7,2.6 h .8 l .6,2.2 2.6,1.3 1.3,1.1 1.4,3"
    ></path>
    <path className="ma-vt" d="m 843.6,155.3 12.4,-2.7"></path>
    <path className="md-pa" d="m 757.4,241.9 60.5,-11.8"></path>
    <path
      className="md-va"
    ...
    ></path>
    <path className="mi-oh" d="m 663.4,211.2 21.4,-3.5"></path>
    <path
      className="mi-wi"
    ...
    <path
      className="mo-ne"
      d="m 491.5,259.5 -3.9,-6.3 -2.1,-3.7 .3,-1.4 -1.3,-1.3"></path>
    <path className="mo-ok" d="m 504.3,326.3 .2,10.8"></path>
    <path
      className="mo-tn"
      d="m 591.7,344.9 1,-2 1.2,-.5 v -.7 l -1.2,-1.1 -.6,-1 1.7,.2 .8,-.7 -1.4,-1.5 1.4,-.5 .1,-1 -.6,-1 0,-1.3 m 1,0 .8,.7 .8,-1"
    ></path>
    <path className="ms-tn" d="m 582.6,367.7 38.3,-2.6"></path>
    <path className="mt-nd" d="m 362.5,56.3 -5.2,66.7"></path>
    <path className="mt-sd" d="m 357.3,123 -2,20.7"></path>
    ...
    ></path>
    <path className="nd-sd" d="m 357.3,123 39.2,2.9 46,2.1 29.5,.4"></path>
    <path
      className="ne-sd"
    ...
    ></path>
    <path className="ne-wy" d="m 347.7,231.8 3.7,-44.2"></path>
    <path
      className="nh-vt"
    ...
    ></path>
    <path className="nj-ny" d="m 827.9,190.5 14.6,4.9 -.4,5.9"></path>
    <path
      className="nj-pa"
    ...
    ></path>
    <path className="nm-ok" d="m 358.1,322.3 -.6,10.6"></path>
    <path
      className="nm-tx"
      d="m 284.3,431.2 -2,-2.2 .3,-3 34.4,3.6 31.8,2.6 7.9,-99.3 .8,0"
    ></path>
    <path className="nv-or" d="m 93.9,166.5 47,11.2"></path>
    <path className="nv-ut" d="m 188.6,187.8 -21,109"></path>
    <path
      className="ny-pa"
    ...
    ></path>
    <path className="oh-pa" d="m 736.8,225.1 -4.9,-29.9"></path>
    <path
      className="oh-wv"
    ...
    ></path>
    <path className="pa-wv" d="m 736.8,225.1 3.2,19.7 17.4,-2.9"></path>
    <path className="sd-wy" d="m 351.4,187.6 3.9,-43.9"></path>
    <path className="tn-va" d="m 697.7,321.1 28.9,-3.3 .2,-1 4.6,-.5 -.3,.7"
    ></path>
    <path className="ut-wy" d="m 236.5,196 -3.3,21.9 32.1,4.8"></path>
    <path
      className="va-wv"
